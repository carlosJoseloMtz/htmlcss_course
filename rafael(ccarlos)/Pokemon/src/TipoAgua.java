...
public class TipoAgua implements InterfacePoke{
	...
	@Override
		...
		System.out.println("atacaste con hidrobomba, hiciste " +pokemon.getAtaque()+" de daño");
