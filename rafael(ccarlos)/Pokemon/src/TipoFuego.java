...
public class TipoFuego implements InterfacePoke{
	...
	public void ataque(Pokemon pokemon) {
			...
			System.out.println("atacaste con Lanza Llamas, hiciste " +pokemon.getAtaque()+" de daño");
